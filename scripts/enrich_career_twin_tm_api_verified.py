...
def get_json(player_id,kind):
 ...
 for attempt in range(3):
  try:
   ...
   if r.status_code in (429,500,502,503,504):time.sleep(2.0*(attempt+1))
   else:return None
  except Exception:

(()=>{
  ...
  // NEON XI Draft club refresh — post-window audit verified 2026-09-03.
  // Keep ratings/attributes untouched; only current club, league and career history are refreshed here.
  ...
  const OVERRIDES={
    ...
    rb10:{club:'Real Madrid',league:'La Liga'},                  // Denzel Dumfries — from Inter
    cb11:{club:'Real Madrid',league:'La Liga'},                  // Ibrahima Konaté — from Liverpool
  ...
  window.NEON_DRAFT_CLUB_REFRESH={version:'2026-09-03-post-window',changed,ids:Object.keys(OVERRIDES)};
